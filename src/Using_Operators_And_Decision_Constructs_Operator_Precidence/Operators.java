...
public class Operators
{
	public static void main(String[] args)
	{
		...
		//Assignment Operators. (It is a simple operators where it is only assigns values from R.H.S to L.H.S)
		
		int a=30;
		int b=60;
		int c=90;
		
		//Arithmetic Operators.  (It return the values in numbers, so it can be written mostly in int,double,long,short)
		...
		//Relation Operators.  (It return the values in true/false, so it was written in boolean data type)
        ...
        //Logical Operators.  (It is also returns values in true/false, so it was written in boolean data type)
        
        boolean ans=((a<b)&&(a>c));       //And Operator
        boolean ans1=((a<=c)||(c>=b));    //Or  Operator 
        boolean ans2=!(a>c);              //Nor Operator
        
        //Increment/Decrement Operators.  (It return the values in numbers, so it can be written mostly in int,double,long,short)
        ...
        int prec = a+b*c;
        int prec1=(a+b)*c;    //Overridden Operator precedence.Because,+,- operators are lower precedence than *,/,%
        int prec2= a/c*b;
